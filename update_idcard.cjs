...
let content = fs.readFileSync('src/components/StudentIdCard.tsx', 'utf8');

// Replace imports
content = content.replace(
  /import \{ renderStudentIdCardToCanvas \} from '\.\.\/utils\/cardRenderer';/,
...
fs.writeFileSync('src/components/StudentIdCard.tsx', content);
console.log('StudentIdCard updated');
